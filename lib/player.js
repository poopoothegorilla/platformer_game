export default class Player {
  ...
  renderHealthBar() {
    console.log('firing renderHealthBar')
    let style = { font: "16px Arial", fill: "#ff0044", wordWrap: true, wordWrapWidth: this.sprite.width, align: "center", backgroundColor: "#ffff00" };

    this.text = this.game.add.text(100, 100, this.health, style);
