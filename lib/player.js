...
export default class Player {
  ...
  addPlayerAttacks() {
    ...
    attackboxPunch.body.name = "punchBody";
  ...
  update(){
      ...
      if (player.children.length != 0) {
        // Show attackbox
        this.game.debug.body(player.children[0].children[0], "#9090ff", false)
        this.game.debug.spriteInfo(player.children[0].children[0], 32, 256);
      }
