...
const HitDetectionEngine = new HitDetection;
...
function create() {
    ...
    // Add spawned players to HitDetectionEngine to allow it to track them
    HitDetectionEngine.spawn(player);
